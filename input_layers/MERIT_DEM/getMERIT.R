...
system('wget -N -nv -r -np -nH --accept "*.tar.gz" --reject="index.html" --cut-dirs=4 --level=5 --http-user="globaldem" --http-password="preciseelevation" "http://hydro.iis.u-tokyo.ac.jp/~yamadai/MERIT_DEM/"')
...
sapply(regs[5], function(x){ saga_DEM_derivatives(INPUT=paste0("DEM_", x, "_100m.sgrd"), sel=c("SLP","MRN","TPI")) })
